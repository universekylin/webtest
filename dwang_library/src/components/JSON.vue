...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="(item, key) in bookstores.storeTypes" :key="key">{{ key }} : {{ item }}</li>
      </ul>
      ...
      <ul>
        <li v-for="(item, key) in bookstores.openingHours" :key="key">
    ...
    <section class="lab-section">
      ...
      <p v-e>Click the button to see a message.</p>
    </section>
...
import authors from 'C:/Users/ROG/week1~2/dwang_library/src/assets/json/authors.json'
import bookstores from 'C:/Users/ROG/week1~2/dwang_library/src/assets/json/bookstores.json'
